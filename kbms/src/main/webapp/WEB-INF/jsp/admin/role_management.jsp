...
<script type="text/javascript">
	var authc = <%=ContextUtils.hasPermission ("role:add","role:edit","role:del","role:authorize")%>;
</script>
...
<script type="text/javascript" src="${ctx}/resources/js/app/admin/roleManagement.js"></script>
</head>
<body>
